...
} from '@diversifiedfinance/design-system/collapsible-tab-view';
import type { Route } from '@diversifiedfinance/design-system/collapsible-tab-view';
import { TabScrollView } from '@diversifiedfinance/design-system/collapsible-tab-view';
import { Haptics } from '@diversifiedfinance/design-system/haptics';
...
export * from '@diversifiedfinance/design-system/collapsible-tab-view';
...
function HeaderTabView<T extends Route>({
	...
	const _renderScene = (
		...
		const focused =
			navigationState.index === props.route?.index ||
			Platform.OS !== 'web';
		return (
			<>
