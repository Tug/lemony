...
import { useIsomorphicLayoutEffect } from '@diversifiedfinance/design-system/hooks';
import { Modal } from '@diversifiedfinance/design-system/modal';
import type { ModalMethods } from '@diversifiedfinance/design-system/modal';
...
function withModalScreen<P extends object>(
	...
	return function (props: P) {
		...
		const [contextValues, setContextValues] =
			useState<ModalScreenContextValue>({
				setTitle,
				pop: () => {},
				snapToIndex: () => {},
			});
