...
export function TransparentButton({ isDark, ...rest }: BaseButtonProps) {
	return (
		<BaseButton
			isDark={isDark}
			labelStyle={{ color: '#FFF' }}
			iconColor={ICON_COLOR_MAPPER.transparent}
			backgroundColors={CONTAINER_BACKGROUND_MAPPER.transparent}
			{...rest}
		/>
	);
}
