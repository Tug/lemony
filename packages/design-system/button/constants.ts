...
const CONTAINER_BACKGROUND_MAPPER = {
	...
	tertiary: {
		default: ['bg-gray-100', 'bg-gray-900'],
	...
	transparent: {
		default: ['bg-transparent border border-white', 'border-gray-400'],
		pressed: ['bg-gray-200/80 border border-white', 'border-gray-400'],
	},
};
const LABEL_SIZE_TW = {
	small: 'text-xs',
...
const ICON_COLOR_MAPPER = {
	...
	outlined: ['#FFFF', colors.gray[900]],
	transparent: ['#FFFF', '#FFFF'],
};
