...
import { usePreviousValue } from '@diversifiedfinance/app/hooks/use-previous-value';
import { isMobileWeb } from '@diversifiedfinance/app/utilities';
...
export const MuteProvider = ({ children }: { children: any }) => {
	...
	return (
		<MuteContext.Provider value={values}>{children}</MuteContext.Provider>
	);
};
