...
```shell
$ npm install browserslist @diversifiedfinance/browserslist-config --save-dev
```
...
To find out more about contributing to this package or Gutenberg as a whole, please read the project's main [contributor guide](https://github.com/Tug/lemony/tree/HEAD/CONTRIBUTING.md).
